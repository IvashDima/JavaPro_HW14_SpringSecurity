...
<body>
    <div class="container">
        <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/">Accounts List</a></h3>
            ...
            <ul class="pagination">
                ...
                <c:if test="${byClientPages ne null}">
                    <c:forEach var="i" begin="1" end="${byClientPages}">
                        <li><a href="/group/${clientId}?page=<c:out value="${i - 1}"/>"><c:out value="${i}"/></a></li>
                    </c:forEach>
                </c:if>
            </ul>
        </nav>
    ...
    <script>
        ...
        $('#add_account').click(function(){
            window.location.href='/account_add_page';
        });
